...
public class WordTypeLessonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Lesson> wordLessons = new ArrayList<>();
        for (Lesson lesson: lessonList.getLessons()) {
            if (lesson.getUuid() >= 33 && lesson.getUuid() <= 39) wordLessons.add(lesson);
        }
        RecyclerView.Adapter mLessonAdapter = new LessonAdapter(this, wordLessons);
